...
ListView.include({       
        ...
        render_buttons: function($node) {
                var self = this;
                this._super($node);
                    this.$buttons.find('.o_import_bc_xls').click(this.proxy('wizards_import_purchase_order'));
                    this.$buttons.find('.o_import_dv_xls').click(this.proxy('wizards_import_sale_order'));
        },
        ...
        this.do_action({
                ...
                res_model: 'wizards.import.purchase.order',
